...
#define I2C1_TIMEOUT    ((uint32_t)100)
...
#define _CPAL_TIMEOUT_INIT()           __nop()//SysTick_Config((SystemCoreClock / 1000));\
...
#define _CPAL_TIMEOUT_DEINIT()         __nop()                  /*<! Disable the systick timer */ 
...
#define I2C3_IT_OFFSET_PREPRIO          1      /* I2C3 PREEMPTION PRIORITY Offset */ 
...
#ifdef CPAL_DEBUG
#define CPAL_LOG(Str)                   BSP_Ser_Printf(Str)
